...
lyr_MERGE_ALL_PA_1.set('fieldAliases', {'FID': 'FID', 'NO LOT': 'NO LOT', 'LUAS LOT': 'LUAS LOT', 'tsp — hak': 'tsp — hak', 'tsp — ha_1': 'tsp — ha_1', 'tsp — pemi': 'tsp — pemi', 'layer': 'layer', 'path': 'path', });
...
lyr_MERGE_ALL_PA_1.set('fieldImages', {'FID': 'TextEdit', 'NO LOT': 'TextEdit', 'LUAS LOT': 'TextEdit', 'tsp — hak': 'TextEdit', 'tsp — ha_1': 'TextEdit', 'tsp — pemi': 'TextEdit', 'layer': 'TextEdit', 'path': 'TextEdit', });
...
lyr_MERGE_ALL_PA_1.set('fieldLabels', {'FID': 'hidden field', 'NO LOT': 'header label - visible with data', 'LUAS LOT': 'header label - visible with data', 'tsp — hak': 'no label', 'tsp — ha_1': 'no label', 'tsp — pemi': 'no label', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_MERGE_ALL_TS_2.set('fieldLabels', {'Layer': 'no label', 'PaperSpace': 'no label', 'SubClasses': 'no label', 'Linetype': 'no label', 'EntityHand': 'no label', 'Text': 'no label', 'vertex_ind': 'no label', 'vertex_par': 'no label', 'vertex_p_1': 'no label', 'distance': 'no label', 'angle': 'no label', 'FID': 'no label', 'vertex_p_2': 'no label', 'path': 'no label', });
